...
def create_event():
    ...
    cursor.execute('''
        INSERT INTO events (title, description, event_type, start_time, end_time, zoom_link, zoom_meeting_id)
        VALUES (?, ?, ?, ?, ?, ?, ?)
    ''', (
        data['title'],
...
def update_event(event_id):
    ...
    allowed_fields = ['title', 'description', 'event_type', 'start_time', 'end_time', 'zoom_link', 'zoom_meeting_id']
