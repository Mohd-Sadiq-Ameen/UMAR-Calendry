...
def get_analytics():
    ...
    try:
        distribution = analytics_service.get_time_distribution(start_date, end_date)
        daily_breakdown = analytics_service.get_daily_breakdown(days)
...
def get_daily():
    ...
    try:
        daily_data = analytics_service.get_daily_breakdown(days)
